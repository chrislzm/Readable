/*
  Readable: actions/commentActions.js
  By Chris Leung

  Description:

  Contains all Redux comment-related actions used in Readable.
  ...
  For a description of the structure of comment objects, please refer to the
